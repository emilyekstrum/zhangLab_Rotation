...
saveRDS(mouse_hvg_matrix, file = "/Users/emilyekstrum/repos/zhangLab_Rotation/data/processed/mouse_hvg_cell_gene_matrix.rds")
```

# or store as mouse HVG gene by cell matrix
```{r}
mouse_hvg_matrix_gene_by_cell <- t(mouse_hvg_matrix)
dim(mouse_hvg_matrix_gene_by_cell) # number of HVGs x number of cells
...
saveRDS(mouse_hvg_matrix_gene_by_cell, file = "/Users/emilyekstrum/repos/zhangLab_Rotation/data/processed/mouse_hvg_gene_cell_matrix.rds")
```
...
```{r mouse-hvg-matrix}
human_hvg_matrix <- GetAssayData(human_seurat, assay = "SCT", layer = "data")[hvg_human, ]
...
```{r save-hvg-matrix}
saveRDS(human_hvg_matrix, file = "/Users/emilyekstrum/repos/zhangLab_Rotation/data/processed/human_hvg_gene_cell_matrix.rds")
```
...
# save mouse HVG gene by cell matrix
```{r}
saveRDS(human_hvg_matrix_cell_by_gene, file = "/Users/emilyekstrum/repos/zhangLab_Rotation/data/processed/human_hvg_cell_gene_matrix.rds")
```
