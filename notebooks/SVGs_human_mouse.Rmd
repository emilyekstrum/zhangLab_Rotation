...
saveRDS(mouse_svg_matrix, file = "/Users/emilyekstrum/repos/zhangLab_Rotation/data/processed/mouse_svg_matrix.rds")
```
...
length(mouse_stew_svg)
head(mouse_stew_svg, 20)
```
...
saveRDS(human_svg_matrix, file = "/Users/emilyekstrum/repos/zhangLab_Rotation/data/processed/human_svg_matrix.rds")
```
