...
5. Saves seurat object as RDS file
...
```
nCount_RNA vs nFeature_RNA: Positive correlation & tight monotonic relationship (r 0.93)
  - spots with higher counts tend to have more detected genes.
nCount_RNA vs percent.mt: No strong correlation (r -0.04)
  - spots with high counts do not necessarily have high mitochondrial percentage
nFeature_RNA vs percent.mt: No strong correlation (r -0.15)
...
```{r save, results='asis'}
out_dir <- "/Users/emilyekstrum/repos/zhangLab_Rotation/data/processed/seurat_objs"
...
# save as h5ad file
```{r}
as.anndata(mouse_seurat_sct,
           filename = file.path(out_dir, "mousebrain_seurat.h5ad"),
           assay = "SCT",
           verbose = TRUE)
```
