...
```{r}
# HVG PCA
hvg_pca <- prcomp(as.matrix(mouse_hvg_matrix), center = TRUE, scale. = TRUE)
hvg_pca_embeds <- as.data.frame(hvg_pca$x)

# plot 2 PCs
ggplot(hvg_pca_embeds, aes(x = PC1, y = PC2)) +
...
saveRDS(hvg_umap_embeds, file = "/Users/emilyekstrum/repos/zhangLab_Rotation/data/processed/baseline_embeds/human_hvg_umap_embeddings.rds")
saveRDS(nnSVG_umap_embeds, file = "/Users/emilyekstrum/repos/zhangLab_Rotation/data/processed/baseline_embeds/human_nnSVG_umap_embeddings.rds")
saveRDS(seurat_svg_umap_embeds, file = "/Users/emilyekstrum/repos/zhangLab_Rotation/data/processed/baseline_embeds/human_seurat_svg_umap_embeddings.rds")

saveRDS(hvg_pca_embeds, file = "/Users/emilyekstrum/repos/zhangLab_Rotation/data/processed/baseline_embeds/mouse_hvg_pca_embeddings.rds")
saveRDS(nnSVG_pca_embeds, file = "/Users/emilyekstrum/repos/zhangLab_Rotation/data/processed/baseline_embeds/mouse_nnSVG_pca_embeddings.rds")
saveRDS(seurat_svg_pca_embeds, file = "/Users/emilyekstrum/repos/zhangLab_Rotation/data/processed/baseline_embeds/mouse_seurat_svg_pca_embeddings.rds")

saveRDS(hvg_umap_embeds, file = "/Users/emilyekstrum/repos/zhangLab_Rotation/data/processed/baseline_embeds/mouse_hvg_umap_embeddings.rds")
saveRDS(nnSVG_umap_embeds, file = "/Users/emilyekstrum/repos/zhangLab_Rotation/data/processed/baseline_embeds/mouse_nnSVG_umap_embeddings.rds")
saveRDS(seurat_svg_umap_embeds, file = "/Users/emilyekstrum/repos/zhangLab_Rotation/data/processed/baseline_embeds/mouse_seurat_svg_umap_embeddings.rds")
```
