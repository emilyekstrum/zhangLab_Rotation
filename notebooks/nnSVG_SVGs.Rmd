...
saveRDS(mouse_svg_matrix, file = "/Users/emilyekstrum/repos/zhangLab_Rotation/data/processed/nnSVG_mouse_svg_gene_cell_matrix.rds")
```
...
saveRDS(mouse_svg_matrix, file = "/Users/emilyekstrum/repos/zhangLab_Rotation/data/processed/nnSVG_mouse_svg_cell_gene_matrix.rds")
```
...
```{r}
# sort by rank column
human_res <- human_res[order(human_res$rank), ]
...
saveRDS(human_svg_matrix, file = "/Users/emilyekstrum/repos/zhangLab_Rotation/data/processed/nnSVG_human_svg_gene_cell_matrix.rds")
```
...
# save mouse SVG matrix
```{r save-human-svg-matrix}
saveRDS(human_svg_matrix, file = "/Users/emilyekstrum/repos/zhangLab_Rotation/data/processed/nnSVG_human_svg_cell_gene_matrix.rds")
```
