...
saveRDS(mouse_svg_matrix, file = "/Users/emilyekstrum/repos/zhangLab_Rotation/data/processed/seurat_mouse_svg_gene_cell_matrix.rds")
```
...
saveRDS(mouse_svg_matrix, file = "/Users/emilyekstrum/repos/zhangLab_Rotation/data/processed/seurat_mouse_svg_cell_gene_matrix.rds")
```
...
```{r save-human-svg-matrix}
saveRDS(human_svg_matrix, file = "/Users/emilyekstrum/repos/zhangLab_Rotation/data/processed/seurat_human_svg_gene_cell_matrix.rds")
```
...
# save mouse SVG matrix
```{r save-human-svg-matrix}
saveRDS(human_svg_matrix, file = "/Users/emilyekstrum/repos/zhangLab_Rotation/data/processed/seurat_human_svg_cell_gene_matrix.rds")
```
